package com.example.QuocTuan.thi;
...
public class MainActivity extends AppCompatActivity implements View.OnFocusChangeListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.QuocTuan.thi.text.R.layout.activity_main);
        kiemtra=false;
        listView=(ListView) findViewById(com.example.QuocTuan.thi.text.R.id.listview);
        sinhvienList=new ArrayList<Sinhvien>();
        registerForContextMenu(listView);
    }
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.example.QuocTuan.thi.text.R.menu.menu,menu);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        getMenuInflater().inflate(com.example.QuocTuan.thi.text.R.menu.context,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case com.example.QuocTuan.thi.text.R.id.them:
                hienthiDialog();
    ...
    public void onFocusChange(View view, boolean b) {
        ...
        switch (id)
        {
            case com.example.QuocTuan.thi.text.R.id.extma:
                String masv=null;
                if(!b)
                {
                ...
                ;break;
            case com.example.QuocTuan.thi.text.R.id.extten:
                 String tensv=null;
                if(!b)
                {
                ...
                ;break;
            case com.example.QuocTuan.thi.text.R.id.tuoi:
                String tuoisv=null;
                if(!b)
                {
    ...
    private void layDulieu()
    {
            if(kiemtrathem())
            {
                ...
                sv.setTuoi(tuoisv);
                sinhvienList.add(sv);
                adapterSinhVien=new AdapterSinhVien(this,sinhvienList, com.example.QuocTuan.thi.text.R.layout.dong_sinhvien);
    ...
    private void hienthiDialog()
    {
        ...
        View mView = getLayoutInflater().inflate(com.example.QuocTuan.thi.text.R.layout.activity_them, null);
        ma=(EditText)    mView.findViewById(com.example.QuocTuan.thi.text.R.id.extma);
        ten=(EditText)   mView.findViewById(com.example.QuocTuan.thi.text.R.id.extten);
        tuoi=(EditText)  mView.findViewById(com.example.QuocTuan.thi.text.R.id.tuoi);
        btnhuy=(Button)  mView.findViewById(com.example.QuocTuan.thi.text.R.id.btnhuy);
        btnthem=(Button) mView.findViewById(com.example.QuocTuan.thi.text.R.id.btnthem);
    ...
    public void onClick(View view)
    {
        int id = view.getId();
        switch (id) {
            case com.example.QuocTuan.thi.text.R.id.btnthem:
                layDulieu();
                break;
        }
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            case com.example.QuocTuan.thi.text.R.id.xoa:
                ...
                dialog.show();
                break;
            case com.example.QuocTuan.thi.text.R.id.sua:
    ...
    {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(MainActivity.this);
        View mView = getLayoutInflater().inflate(com.example.QuocTuan.thi.text.R.layout.update, null);
         suama=(EditText)    mView.findViewById(com.example.QuocTuan.thi.text.R.id.extsuama);
        suaten=(EditText)   mView.findViewById(com.example.QuocTuan.thi.text.R.id.extsuaten);
        suatuoi=(EditText)  mView.findViewById(com.example.QuocTuan.thi.text.R.id.extsuatuoi);
        xong=(Button)        mView.findViewById(com.example.QuocTuan.thi.text.R.id.btnxong);
